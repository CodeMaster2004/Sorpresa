...
document.getElementById('whatsappBtn').addEventListener('click', function() {
    // Reemplaza "tuNumero" con el número de teléfono al que quieres redirigir
    const numeroTelefono = "51959194913"; // Incluye el código de país sin el "+"
    const mensaje = "Hola";
